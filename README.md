...
官网：[adb-bot.hilbp.com](https://adb-bot.hilbp.com/?utm_source=github&utm_medium=adb-bot&utm_campaign=readme)

## OpenClaw 集成

安装 Skill 后，通过 OpenClaw 对话指挥你的手机。
...
- **AI 剧本生成** — 输入视频主题，自动生成分镜头剧本（画面描述、旁白、时长）
- **AI 视频生成** — 文生视频、图生视频，一键批量生成所有镜头
- **一键成片** — 对接 MoneyPrinterTurbo，自动合成配音、字幕，输出成品视频
...
- 客户运营与自动应答
- 新媒体内容分发
- AI 视频创作，编剧 · 生成 · 成片 · 发布，一站式短视频运营闭环
- 设备自动化 (RPA)
